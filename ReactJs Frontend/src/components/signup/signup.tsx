...
const validationSchema = Yup.object().shape({
  Name: Yup.string()
    ...
    .test(
      "name-validation",
      "Name must not be less than two names",
      (value) => {
...
function App() {
  ...
  const signup = async (formData: IFormData) => {
    ...
    <>
      <div className={styles.container}>
        <div className={styles.leftside}>
          ...
          <h2 className={styles.header} onSubmit={handleSubmit}>
            Create an account
          </h2>
          <form onSubmit={handleSubmit} className={styles.form}>
            <p className={styles.details}>Full Name</p>
            <input
            ...
            <input
              ...
              required
            />
            <p className={styles.details}>Phone Number</p>
            <input
              className={styles.forminput}
              onChange={handleinputChange}
              name="PhoneNumber"
            ...
            <p className={styles.link}>
              ...
              <Link className={styles.link2} to="/users/login">
                Login
              </Link>
            </p>
          </form>
